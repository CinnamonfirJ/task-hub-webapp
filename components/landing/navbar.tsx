    ...
    >
      ...
      <div className="hidden md:flex items-center gap-8">
        {[
          ...
          <Link key={link.href} href={link.href} className="relative group text-[15px] font-medium text-[#4B5563] hover:text-[#1F2937] transition-colors">
            {link.label}
      ...
      {isOpen && (
        ...
        >
           ...
           <Link href="#for-taskers" className="text-sm font-medium text-gray-700 py-2">For Taskers</Link>
