    ...
    <section className="py-24 px-4 md:px-8 max-w-6xl mx-auto bg-white">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
          Loved by <span className="font-instrument font-light text-[#6B46C1]">Thousands</span>
        </h2>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
        ...
        >
          ...
          <p className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug mb-8">
            "I needed someone to paint and bind my project in a few hours. I posted a task and a verified campus student showed up in 30 mins. All on one platform!"
          </p>
          <div className="flex items-center gap-4 mt-auto">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 font-medium">University Student</p>
            </div>
          </div>
        </motion.div>
