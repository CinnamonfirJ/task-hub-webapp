...
import { ArrowRight, Briefcase, Users, CreditCard, Calendar, TrendingUp, Heart, Target, Megaphone, BarChart3 } from "lucide-react"
import { motion } from "framer-motion"
import { fadeInUp, staggerContainer, listContainer, scaleOnHover } from "@/utils/landing-animations"
...
export default function ProviderCTA() {
  return (
    <section className="px-6 py-20 max-w-7xl mx-auto bg-white">
      ...
      >
        <motion.span variants={fadeInUp} className="inline-flex items-center gap-2 text-[#7C3AED] font-semibold text-[10px] mb-4 uppercase tracking-[0.2em]">
        ...
        <motion.p variants={fadeInUp} className="text-[#6B7280] text-[16px] max-w-2xl mx-auto">
          Whether you're a freelancer or run a business, join our growing community of service providers.
        </motion.p>
      </motion.div>
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-[14px]">Set your own rates and work on your terms</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-[14px]">Bid only on tasks that interest you</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-[14px]">Earn badges and climb the leaderboard</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-[16px] font-bold mb-1">Keep More Earnings</h4>
                <p className="text-white/80 text-[14px]">Low platform fees, more in your pocket</p>
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-[16px] font-bold mb-1">Reach New Customers</h4>
                <p className="text-white/80 text-[14px]">Access thousands of potential clients</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-[14px]">Get matched with relevant service requests</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-[16px] font-bold mb-1">Market Your Services</h4>
                <p className="text-white/80 text-[14px]">Showcase your portfolio and reviews</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-[14px]">Expand your presence in Alabama and beyond</p>
              </div>
            </motion.div>
          </motion.div>
