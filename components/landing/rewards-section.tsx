    ...
    <section className="relative px-6 py-20 max-w-7xl mx-auto overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-16">
          <motion.span variants={fadeInUp} className="inline-flex items-center gap-2 bg-[#F3E8FF] text-[#7C3AED] px-4 py-2 rounded-full text-[12px] font-semibold uppercase tracking-wider mb-6">
            <Award className="w-4 h-4" />
            Rewards and Recognition
          </motion.span>
          <motion.h2 variants={fadeInUp} className="text-3xl md:text-[40px] font-bold text-[#1F2937] mb-4 leading-tight">
            The more you use, <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7C3AED] to-[#6D28D9]">the more you earn</span>
          </motion.h2>
          <motion.p variants={fadeInUp} className="text-[#6B7280] text-[16px] max-w-2xl mx-auto leading-relaxed">
            Our gamified experience keeps you engaged and rewarded — whether you're hiring or working.
          </motion.p>
        </div>
        ...
        >
          ...
          >
            ...
            <p className="text-[#6B7280] text-[14px] leading-relaxed mb-6">
              Each completed task gets you closer to discounts and exclusive perks. The more you use Generic Service Edge, the more you save.
            </p>
          ...
          >
            ...
            <div className="p-8 flex flex-col flex-grow">
              ...
              <p className="text-[#6B7280] text-[14px] leading-relaxed">
                Top taskers and repeat customers unlock special badges that build credibility. Your reputation becomes your currency.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#6B7280] text-[14px] leading-relaxed mb-6">
              Book with the same tasker or business and unlock special bonuses. Loyalty pays off in real ways.
            </p>
            <div className="mt-auto -mx-8 -mb-8">
              <img
