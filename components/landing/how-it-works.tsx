    ...
    <section id="how-it-works" className="px-6 py-20 max-w-7xl mx-auto">
      ...
      >
        ...
        <motion.h2 variants={fadeInUp} className="text-3xl md:text-[48px] font-semibold text-[#1F2937] mb-6 leading-tight tracking-tight">
          Three simple steps to <span className="text-[#8B5CF6]">getting it done</span>
        </motion.h2>
        <motion.p variants={fadeInUp} className="text-[#4B5563] text-lg md:text-[18px] max-w-[720px] mx-auto font-medium leading-relaxed">
          No more endless searching. Post your task and let qualified professionals come to you.
        </motion.p>
      </motion.div>
      ...
      >
        <p className="text-[#64748B] font-medium mb-3 text-[15px]">Ready to Experience the Difference?</p>
        <motion.a 
