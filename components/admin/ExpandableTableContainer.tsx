      ...
      <div className={cn(
        ...
        {!isExpanded ? (
          <Button
            ...
            className='bg-[#6B46C1] hover:bg-[#553C9A] text-white px-10 rounded-xl text-sm font-bold h-12 transition-all  hover:-translate-y-0.5'
          >
            Load more
          </Button>
        ) : (
              ...
              <React.Fragment key={idx}>
                {p === "..." ? (
                  ...
                  <button
                    ...
                    className={cn(
                      "w-10 h-10 flex items-center justify-center rounded-xl text-sm font-bold transition-all border ",
                      currentPage === p
