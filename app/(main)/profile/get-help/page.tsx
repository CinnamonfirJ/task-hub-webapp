    ...
    return (
        <div className="p-4 md:p-8 max-w-2xl mx-auto space-y-10 pb-20">
            ...
            <div className="space-y-6">
                ...
                {/* Email Support */}
                <Card className="border border-gray-50  rounded-[2rem] overflow-hidden">
                    <CardContent className="p-6 space-y-6">
                        ...
                        <Button className="w-full bg-[#6B46C1] hover:bg-[#553C9A] py-7 text-sm font-bold rounded-xl  ">
                            Send Email
                        </Button>
                    </CardContent>
                </Card>
                ...
                {/* Support Hours */}
                <Card className="bg-purple-50/30 border border-purple-100  rounded-[2rem] overflow-hidden">
