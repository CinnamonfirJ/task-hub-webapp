      ...
      {user?.role === "tasker" ? (
        <div className='space-y-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <StatCard
              icon={<Briefcase size={18} className='text-[#6B46C1]' />}
        ...
        <Card className='bg-linear-to-br from-[#673AB7] to-[#512DA8] border-none shadow-xl rounded-[2.5rem] overflow-hidden text-white'>
          <CardContent className='p-8 space-y-8'>
            <div className='flex justify-between items-center'>
              ...
              <Button
                variant='secondary'
                className='bg-white/20 hover:bg-white/30 text-white border-none rounded-xl px-6 flex items-center gap-2'
              >
                <Plus size={18} /> Fund
              </Button>
            </div>
