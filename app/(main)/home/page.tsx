          ...
          <div className='flex items-center gap-2'>
            {isLoadingUser ? (
              ...
              <>
                ...
                {isTasker && (
                  <span
                    className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-[10px] font-black border transition-colors ${
                      isVerified
      ...
      <div className='space-y-6'>
        ...
        {isLoading ? (
          ...
          recentTasks.length > 0 ? (
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              {recentTasks.slice(0, 2).map((task) => (
                <div
                  key={task._id}
                  className='bg-white border border-gray-100 p-8 rounded-[2.5rem] shadow-sm space-y-6'
                >
                  <div className='flex justify-between items-start'>
                    ...
                    <span className='text-[#4CAF50] font-black text-2xl'>
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-center gap-3'>
                      ...
                      <span className='text-gray-400 text-sm font-semibold'>
                        Posted by {task.user?.fullName || "Task Hub"}
                      </span>
                    </div>
          ...
          <div className='relative bg-[#6B46C1] shadow-xl p-10 rounded-[2.5rem] w-full overflow-hidden text-white'>
            ...
            {/* Content */}
            <div className='mb-10'>
              <h2 className='mb-3 font-bold text-4xl leading-tight'>
                {featuredTask.title}
              </h2>
            ...
            <div className='flex justify-between items-end'>
              <div className='bg-[#4CAF50] p-4 px-8 rounded-2xl'>
          ...
          <div className='relative bg-linear-to-br from-[#673AB7] to-[#512DA8] shadow-xl p-10 rounded-[2.5rem] w-full overflow-hidden text-white text-center flex flex-col items-center'>
