  ...
  return (
    <div className='space-y-6 md:space-y-8 p-4 md:p-8 max-w-[1400px] mx-auto'>
      ...
      <div className='flex items-center gap-2 overflow-x-auto pb-2 md:pb-0'>
        {["All", "Unread", "Flagged", "Resolved"].map((filter) => (
          <button
            ...
            className={`px-4 py-2 rounded-lg text-xs font-semibold whitespace-nowrap transition-colors ${activeFilter === filter
      ...
      <div className='flex flex-col md:flex-row gap-6 h-[800px]'>
        {/* Sidebar */}
        <Card className='w-full md:w-[350px] lg:w-[400px] border border-gray-100  rounded-2xl flex flex-col h-full bg-white shrink-0'>
                ...
                <Link key={conv._id} href={`/admin/messages/${conv._id}`}>
                  ...
                  >
                    ...
                    <div className='flex items-center gap-2 mt-1'>
                      ...
                      <span
                        className={`text-[10px] font-bold capitalize ${conv.status === "flagged"
                            ? "text-red-400"
                            : "text-gray-400"
                          }`}
                      >
        ...
        <div className='flex-1 min-w-0 h-full'>
          <Card className='h-full border border-gray-100  rounded-2xl overflow-hidden bg-white'>
            {children}
          </Card>
        </div>
      </div>
