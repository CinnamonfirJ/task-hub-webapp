    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Monitor all financial transactions</p>
        </div>
        <div className="flex gap-3">
          <Button variant="outline" className="text-sm h-10 px-4 gap-2 border-gray-200">
             Default
          </Button>
          <Button variant="outline" className="text-sm h-10 px-4 gap-2 border-gray-200">
              ...
              <tbody className="divide-y">
                {transactions.map((tx) => (
                  <tr key={tx.id} className="group hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-5 text-gray-900 font-medium">{tx.user}</td>
                    <td className="px-6 py-5 text-gray-500">{tx.description}</td>
                    ...
                    <td className="px-6 py-5 font-bold text-gray-900">{tx.amount}</td>
