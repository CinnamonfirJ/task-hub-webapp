      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>KYC Data:</strong> To comply with KYC/AML rules, Taskers must submit identity documents (passport or national ID/NIN) and a live selfie. We also collect NIN for certain verifications. Didit, QoreID, and Authentify verify these; we do not retain sensitive raw data longer than needed.</li>
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>KYC/Verification:</strong> To verify Tasker identities (via Didit, QoreID, and Authentify) and comply with anti-fraud and regulatory requirements.</li>
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Service Providers:</strong> We share data with processors under contract (e.g. Didit, QoreID, and Authentify for KYC; payment gateways; cloud hosting providers; email/SMS services) as needed to operate TaskHub.</li>
