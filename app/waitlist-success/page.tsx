          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/">
              <motion.button
                ...
                whileHover="hover"
                whileTap="tap"
                className="px-8 py-4 rounded-full border border-gray-200 bg-white text-[#374151] font-semibold hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 text-[15px] "
              >
            ...
            <motion.button
              ...
              whileHover="hover"
              whileTap="tap"
              className="bg-[#7C3AED] text-white px-8 py-4 rounded-full font-semibold hover:bg-[#6D28D9] transition-colors flex items-center justify-center gap-2 text-[15px]  "
              onClick={() => {
                confetti({
                  particleCount: 150,
                  spread: 70,
