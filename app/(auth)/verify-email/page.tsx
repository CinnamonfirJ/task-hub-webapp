...
function VerifyEmailForm() {
  ...
  const { verify, verifyAsync, isVerifying, verifyError, resendCode, isResending } =
    useVerifyEmail();
          ...
          {verifyError && (
            <div className="mt-4 space-y-4 w-full">
              <Alert variant="destructive">
                <AlertDescription>
                  {(verifyError as Error).message || "Invalid or expired verification link"}
                </AlertDescription>
              </Alert>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 pt-4">
          <div className="flex flex-col items-center gap-3">
             <label className="text-sm font-semibold text-gray-700">Enter 5-digit code</label>
